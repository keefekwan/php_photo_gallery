...
<?php
	...
	if (isset($_POST["submit"])) {
		...
		if ($new_comment && $new_comment->save()) { // new comment and try to save new comment
			// Comment saved
			...
			// But then if the page is reloaded, the form will try to 
			// resubmit the comment. So redirect instead:
...
<div id="comments">
	...
	<?php endforeach; ?>
	<?php if (empty($comments)) { "No comments"; } ?>
</div>
